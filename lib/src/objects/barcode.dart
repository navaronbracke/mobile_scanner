...
import 'package:mobile_scanner/src/objects/phone_number.dart';
...
class Barcode {
  ...
  factory Barcode.fromMap(Map<Object?, Object?> data) {
    final Map<Object?, Object?>? calendarEvent = data['calendarEvent'] as Map<Object?, Object?>?;
    final List<Object?>? corners = data['corners'] as List<Object?>?;
    final Map<Object?, Object?>? contactInfo = data['contactInfo'] as Map<Object?, Object?>?;
    final Map<Object?, Object?>? driverLicense = data['driverLicense'] as Map<Object?, Object?>?;
    final Map<Object?, Object?>? email = data['email'] as Map<Object?, Object?>?;
    final Map<Object?, Object?>? geoPoint = data['geoPoint'] as Map<Object?, Object?>?;
    final Map<Object?, Object?>? phone = data['phone'] as Map<Object?, Object?>?;
    final Map<Object?, Object?>? sms = data['sms'] as Map<Object?, Object?>?;
    final Map<Object?, Object?>? urlBookmark = data['url'] as Map<Object?, Object?>?;
    final Map<Object?, Object?>? wifi = data['wifi'] as Map<Object?, Object?>?;

    return Barcode(
      calendarEvent: calendarEvent == null ? null : CalendarEvent.fromMap(calendarEvent),
      contactInfo: contactInfo == null ? null : ContactInfo.fromMap(contactInfo),
      ...
      driverLicense: driverLicense == null ? null : DriverLicense.fromMap(driverLicense),
      email: email == null ? null : Email.fromMap(email),
      format: BarcodeFormat.fromRawValue(data['format'] as int? ?? -1),
      geoPoint: geoPoint == null ? null : GeoPoint.fromMap(geoPoint),
      phoneNumber: phone == null ? null : PhoneNumber.fromMap(phone),
      rawBytes: data['rawBytes'] as Uint8List?,
      rawValue: data['rawValue'] as String?,
      sms: sms == null ? null : SMS.fromMap(sms),
      type: BarcodeType.fromRawValue(data['type'] as int? ?? 0),
      urlBookmark: urlBookmark == null ? null : UrlBookmark.fromMap(urlBookmark),
      wifi: wifi == null ? null : WiFi.fromMap(wifi),
    );
  }
